...
const PortfolioDetailComponent = () => {
   return (
      <section className="px-6 lg:px-40 flex flex-col gap-12 mt-20">
         <div>
            <img src={PortfolioDetailImg} alt="Portfolio detail" />
         </div>

         <div className="flex flex-col gap-10">
            <h2 className="text-6xl md:text-8xl font-bold">Portfolio Title</h2>
            ...
            <article>
               <h3 className="text-3xl font-bold mb-3">Why do we use it?</h3>
            ...
            <article>
               <h3 className="text-3xl font-bold mb-3">Where can I get some?</h3>
               <p className="font-normal text-xl text-gray-700">
